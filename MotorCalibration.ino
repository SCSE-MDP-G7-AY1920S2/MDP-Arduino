...
const int MOVE_FAST_SPEED = 390; // Recommend to start at 350 - slowly amp up til nearing 400
const int MOVE_SLOW_SPEED = 310; // Recommend to start at 280 - slowly amp up
